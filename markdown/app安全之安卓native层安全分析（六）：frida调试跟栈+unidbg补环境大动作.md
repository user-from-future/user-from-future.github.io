...
继续跟着龙哥的unidbg学习： [SO逆向入门实战教程六：s\_白龙\~的博客-CSDN博客](https://blog.csdn.net/qq_38851536/article/details/117923970 "SO逆向入门实战教程六：s_白龙~的博客-CSDN博客")
...
![](https://img-blog.csdnimg.cn/img_convert/49e44a445cdad42e4c7dfcb4b07a4c13.png)
...
![](https://img-blog.csdnimg.cn/img_convert/c75cf80c777da44bf18e6ec438456b97.png)

目前确实还不确定是不是这里，用objection hook下就知道了：

先hook了类，一堆，卧槽

![](https://img-blog.csdnimg.cn/img_convert/f81ada7a4654522431e65c97ea982949.png)

hook tostring方法：

![](https://img-blog.csdnimg.cn/img_convert/d71b54a9165ae94eac9ccae54a5fe282.png)

app多划两下：可以看到基本是对的上的

![](https://img-blog.csdnimg.cn/img_convert/73495a176d3f4378f1c807759ae3d4bd.png)

然后再找找堆栈调用，很快定位到这里：

![](https://img-blog.csdnimg.cn/img_convert/42df460fc999ca7a05f3a805286ea594.png)

hook下这个类，发现有一堆，

慢慢来，首先这个appkey，就是这里了

![](https://img-blog.csdnimg.cn/img_convert/8c1e7c7b81eaca442fbd33b48ce3cdcf.png)
...
![](https://img-blog.csdnimg.cn/img_convert/91770aca68de37879d994cf21f4a1b37.png)

感觉就是这个s了，入参是：

> \{"ad\_extra":"E0DA3BAB712CAB3902D558CFD4FEB865AB1563B7D61A4A57D02854BB9A4512C5E4737CA15664C505F3E63B954BB68837690B81FE77B2E7EB578F3E3D7C528439725348FE86527D7415BA2267FCCD2C95895AE80E69A960812FE60  
...
> ":"1d8b6e7d45233436","autoplay\_card":"11","build":"6180500","c\_locale":"zh\_CN","channel":"shenma069","column":"2","device\_name":"MI 6","device\_type":"0","flush":"8","fnval":"400","fnver":"0","force\_host":"  
> 0","fourk":"1","guidance":"0","https\_url\_req":"0","idx":"1682561936","inline\_danmu":"2","inline\_sound":"1","login\_event":"0","mobi\_app":"android","network":"wifi","open\_event":"","platform":"android","play  
> er\_net":"1","pull":"false","qn":"32","recsys\_mode":"0","s\_locale":"zh\_CN","splash\_id":"","statistics":"\{\\"appId\\":1,\\"platform\\":3,\\"version\\":\\"6.18.0\\",\\"abtest\\":\\"\\"\}"\}
...
![](https://img-blog.csdnimg.cn/img_convert/8ab7682af842b92eb56d289d00b081c2.png)

根据我们之前的定律，加载so文件都是static方法，然后，system.loadlibrary，但是这里就奇怪了，啥都没有

只看到这里有点可疑：

![](https://img-blog.csdnimg.cn/img_convert/09078f2e8f239777b6dc98fbdceb5944.png)

点进去，知道G是bili

![](https://img-blog.csdnimg.cn/img_convert/3a2cb694630f5321c7f30b35325ba2dd.png)

c.c会不会是system.loadlibrary呢？追进去：

![](https://img-blog.csdnimg.cn/img_convert/f5e6cf15af42a2703f89895cf1c56072.png)

看到使用str只有f，其他的逻辑我们可以不用管

![](https://img-blog.csdnimg.cn/img_convert/b4ff14b8359f2a0eecd3bfe76495f271.png)

f追进去，我们知道，后面两个参数是null，因为根本就没传这两个，那就是这个g方法

![](https://img-blog.csdnimg.cn/img_convert/45dc5c84fe906098b6a6e895590bcf80.png)

g追进去，然后一下就看到了这个loadlibrary:

![](https://img-blog.csdnimg.cn/img_convert/509aa9e83232e99f5960959be6c9dc17.png)

再追进去，感觉这个【com.getkeepsafe.relinker】类有点奇怪

![](https://img-blog.csdnimg.cn/img_convert/bd6d1ae643fdb12e609c766d49ecdc19.png)

网上搜一下即可：

> [KeepSafe/ReLinker：一个强大的Android原生库加载器。 \(github.com\)](https://github.com/KeepSafe/ReLinker "KeepSafe/ReLinker：一个强大的Android原生库加载器。 (github.com)")

看到这个介绍，ok，就是这里了。

![](https://img-blog.csdnimg.cn/img_convert/aa29c2699404fea2a9ac7b2a1cde4a7c.png)

所以我们的so文件就是这个bili了。

### 2.搭架子

![](https://img-blog.csdnimg.cn/img_convert/6706cfb79ebac8d0ff12852b61ecf8f1.png)

又报了这个错：

> \[main\]W/libc: pthread\_create failed: clone failed: Out of memory
...
![](https://img-blog.csdnimg.cn/img_convert/650216143e180a7871b011c09e881dbe.png)

ok了

而且，我们的目标函数地址也打印出来了：

![](https://img-blog.csdnimg.cn/img_convert/e4b7542b132e61395884fae04f0623e5.png)

### 3.开始调用s方法

但是参数是TreeMap，根据龙哥的博客说的，需要搞个继承关系，map->abstractMap->TreeMap

![](https://img-blog.csdnimg.cn/img_convert/d753cbe361466cef0513eb4b86863ede.png)

补一下：

![](https://img-blog.csdnimg.cn/img_convert/5466e870b8387693c48d0c0dc1ed0187.png)

继续补：

![](https://img-blog.csdnimg.cn/img_convert/ff9f1bf0f78f8ac1e414482cd2f9a4d5.png)

插一句，如果这里，你没给ts，会报如下错，而且提示都没有，就很骚，我是用frida hook到的某一个流程的参数，刚好就没有ts。但是实际调用的时候是有ts的：

![](https://img-blog.csdnimg.cn/img_convert/113505edb7f7564133e9c205e703a8ff.png)

回到刚才的地方，卧槽，他这里要一个 SignedQuery对象的r方法，也就是这个：

![](https://img-blog.csdnimg.cn/img_convert/720529b39c76261ca89826c799936594.png)

新建了一个util类，然后把jadx的copy过来，导入好已有的，然后如下：

![](https://img-blog.csdnimg.cn/img_convert/2b4c1819dea917a96333243979982a85.png)

把ContainerUtils的这两个属性拿过来：

![](https://img-blog.csdnimg.cn/img_convert/04f42714cee52afe322ddb0bfe9b6e14.png)

现在就差b方法了

![](https://img-blog.csdnimg.cn/img_convert/f2dc560fd9a059dfc1e47eb6024b4bab.png)

![](https://img-blog.csdnimg.cn/img_convert/9f9491af04150be43d95d356d5123414.png)

把a,b,c都copy完，还有这个：

![](https://img-blog.csdnimg.cn/img_convert/43c1d97b3f1567e511be9e93049c90b5.png)

![](https://img-blog.csdnimg.cn/img_convert/a68468286d9b6f98181c5420dd7363f5.png)

整过来

现在还有cv.m了，

![](https://img-blog.csdnimg.cn/img_convert/1d6a84fdb470d5b73c9e55bba45ccfc6.png)

![](https://img-blog.csdnimg.cn/img_convert/0062b4cf9b10391c3e49bbdf114c03fb.png)

ok，整好了运行，卧槽，还要这个初始化对象：

![](https://img-blog.csdnimg.cn/img_convert/09f88e28608fc7c42d7490636c2e2ac0.png)

再看看这个类的构造方法是啥：

![](https://img-blog.csdnimg.cn/img_convert/313473a1b1b0491a1af648513aa00e75.png)

也还好，就两个属性

![](https://img-blog.csdnimg.cn/img_convert/9e6b4189548c5773bb6eae3ba68cdf2f.png)

好了终于没有报错了，发现，这个第二个参数就是sign：

![](https://img-blog.csdnimg.cn/img_convert/766ead798e65c571f459a554d39be3e2.png)

再看这个返回结果 ，好像有点不对劲，以前的不都是直接把结果字符串打印出来了吗，这里咋没打印，

![](https://img-blog.csdnimg.cn/img_convert/9abd07883180f54c11941bae2d71b9d6.png)

根据前面的跟栈我们知道，他会调用下toString，那么，这里我们也把toString补上去看看：

![](https://img-blog.csdnimg.cn/img_convert/627ac566dfe267c20de2d4fe4248f9a2.png)
...
![](https://img-blog.csdnimg.cn/img_convert/7e4bb713ee68691bb106837f39d49b6b.png)
...
![](https://img-blog.csdnimg.cn/img_convert/bb3b02316404700c55693c30085c96d1.png)
...
![](https://img-blog.csdnimg.cn/img_convert/af60d714292e333d37843a754305569e.png)
